 ...
 * Validate a zwlr_gamma_control_v1 error value.
 *
 * @return true on success, false on error.
 * @ref zwlr_gamma_control_v1_error
 */
static inline bool
zwlr_gamma_control_v1_error_is_valid(uint32_t value, uint32_t version) {
	switch (value) {
	case ZWLR_GAMMA_CONTROL_V1_ERROR_INVALID_GAMMA:
		return version >= 1;
	default:
		return false;
	}
